...
async function weatherData(country) {
  try {
    var response = await fetch(
      `https://api.weatherapi.com/v1/forecast.json?key=88fb2ba1422a4b2f9ca170656242006 &q=${country}&days=3`
    );
    ...
    all = `
        ...
        <div class="card heigth-card  first-card heigth-card">
            ...
            <div class="card-body ">
                ...
                <h2 id="deg" class="card-title temp">${tempInC}<sup>o</sup>c</h2>
                ...
                <div class="d-flex flex-wrap align-items-center ">
                    ...
                    <span class="space-span weather-info">East</span></p>
                </div>
            </div>
        </div>
    </div>
...
async function intialWeatherData(lat, lon) {
  try {
    var response = await fetch(
      `https://api.weatherapi.com/v1/forecast.json?key=88fb2ba1422a4b2f9ca170656242006 &q=${lat},${lon}&days=3`
    );
    var data = await response.json();
